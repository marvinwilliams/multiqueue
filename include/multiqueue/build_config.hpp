...
static constexpr int DefaultNumPopTries = MQ_NUM_POP_TRIES;
#else
static constexpr int DefaultNumPopTries = 1;
#endif
#ifdef MQ_SCAN_ON_FAILED_POP
static constexpr bool DefaultScanOnFailedPop = true;
#else
static constexpr bool DefaultScanOnFailedPop = false;
#endif
#ifdef MQ_HEAP_ARITY
static constexpr std::size_t DefaultHeapArity = MQ_HEAP_ARITY;
#else
static constexpr std::size_t DefaultHeapArity = 16;
#endif
